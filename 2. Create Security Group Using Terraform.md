...
1. To be sure that the security group is being deployed in `us-east-1` region. We double check into `providers.tf` file 
...
2. In the `aws-client` navigate to `/home/bob/terraform` directory
3. create a new `main.tf` file

```
vi main.tf
``` 

4. Into the directory write the next terraform code lines.
...
- Resource for Security Groups 
https://registry.terraform.io/providers/-/aws/6.8.0/docs/resources/security_group

- Data Source for  VPC
https://registry.terraform.io/providers/-/aws/6.8.0/docs/data-sources/vpc
